...
def build_cnn(input_var=None):
    ...
    network,stacks,layers,errors,watchpoints=deepstacks.lasagne.build_network(network,(
        (0,16   ,5, 1,0,0,{}),
        (swwae_pooling,16,28,2,'where1','what1'),
        (0,32   ,3, 1,0,0,{}),
        (swwae_pooling,32,14,2,'where2','what2'),
        (0,0,0,0,'source',0,{'noise':0.1}),
        (swwae_unpooling,32,14,2,'where2','source'),
        (0,16   ,3, 1,'recon1',0,{}),
        (swwae_unpooling,16,28,2,'where1','recon1'),
