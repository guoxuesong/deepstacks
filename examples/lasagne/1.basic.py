...
def build_mlp(input_var=None):
    ...
    network,stacks,layers,errors,watchpoints=deepstacks.lasagne.build_network(l_in,(
        ...
        # For any lasagne layer we not wrapped or not wapped well, you can
        # alwayse use (0,0,0,0,0,0,{'layer':(layer,arg1,arg2,...,kwargs)})
        # to get it, the return value of layer(arg1,arg2,...,**kwargs) will be
        # insert into the network, use curr_layer to reference the bottom
        # layer.
        (0,0,0,0,0,0,{'layer':(lasagne.layers.DropoutLayer,curr_layer,{'p':0.2})}),

        # A DenseLayer with 500 units, {'dense'} or {'dense':True} is equivalent 
        (0,500,0,0,0,0,{'dense'}),
        (0,0,0,0,0,0,{'layer':(lasagne.layers.DropoutLayer,curr_layer,{'p':0.5})}),
        (0,500,0,0,0,0,{'dense'}),
        (0,0,0,0,0,0,{'layer':(lasagne.layers.DropoutLayer,curr_layer,{'p':0.5})}),

        # Use 'nonlinearity' to set nonlinearity
...
def build_custom_mlp(input_var=None, depth=2, width=800, drop_input=.2,
    ...
    network,stacks,layers,errors,watchpoints=deepstacks.lasagne.build_network(l_in,(
        ...
        (loop,depth,(
            ...
            (0,0,0,0,0,0,{'layer':(lasagne.layers.DropoutLayer,curr_layer,{'p':drop_hidden})}) if drop_hidden else (0,),
            )),
        (0,10,0,0,0,0,{'dense':True,'nonlinearity':lasagne.nonlinearities.softmax}),
        ))
    return network
...
def build_cnn(input_var=None):
    ...
    network,stacks,layers,errors,watchpoints=deepstacks.lasagne.build_network(network,(
        ...
        # Conv2DLayer num_filters=32 filter_size=5 stride=1
        (0,32,5,1,0,0,{}),
